...
class MainActivity : AppCompatActivity() {
    ...
    private fun applyColorMatrixFilter(colorMatrix: ColorMatrix) {
        ...
        filterOverlay.background = android.graphics.drawable.ColorDrawable(Color.TRANSPARENT)
        filterOverlay.background.colorFilter = colorFilter
        
        // Make overlay visible with some transparency
        filterOverlay.alpha = 0.3f
